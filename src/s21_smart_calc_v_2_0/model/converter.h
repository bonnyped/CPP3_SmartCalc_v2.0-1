...
/*!
  \file
  \brief Класс конвертирующий подготовленный вектор токенов в вектор токенов в обратной польской нотации
  \author bonnyped
  \version 2.0
  \date март 2024 года
  ...
  \throw std::logic_error("Unpaired brackets") бросает исключения в случае, если существует проблема с парностью скобок
*/
