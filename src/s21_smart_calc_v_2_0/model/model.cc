...
void Model::determReversePolishNitation(){
    ...
    reverse_polish_notation_ = converter.convertToRpn(validator.getValidatedVector());
}

cvector_token_type Model::getReversePolishNitation() { return reverse_polish_notation_; }

cnumber_number_type Model::getResultForControllerOrGraph() {
