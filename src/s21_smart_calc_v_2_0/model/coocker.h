...
/*!
  \file
  \brief Заголовочный файл класса заготовщика, который нужен для подготовки строки для последующей обработки.
  \author bonnyped
  \version 2.0
  \date март 2024 года
  ...
  - удаление пробелов из входящей строки (необходимо для последующей корректной обработки строки)
...
class entitesMap {
 ...
 private:
 /*!
 \brief Карта-словарь, для замены строчных функций на литеры, для удобства дальнейшей обработки
 */
