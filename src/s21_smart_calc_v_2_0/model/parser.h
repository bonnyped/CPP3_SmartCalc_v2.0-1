...
/*!
  \file
  \brief Класс пасрит строку в вектор токенов, попутно определяя сущность
  лексемы и ее необходимые свойства для дальнейшего перевода в обратную польскую
  нотацию и подсчета. \author bonnyped \version 2.0 \date март 2024 года
