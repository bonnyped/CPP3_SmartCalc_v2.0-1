...
void SmartCalc::fillGraph(const std::vector<double> &x, const std::vector<double> &y)
{
...
//    builded_graph_->setInteraction(QCP::iRangeZoom, true); // увеличение - уменьшение Графикa
